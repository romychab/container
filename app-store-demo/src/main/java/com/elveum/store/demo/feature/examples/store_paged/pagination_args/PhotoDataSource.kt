...
class PhotoDataSource @Inject constructor(
    ...
    suspend fun fetchPage(categories: Set<PhotoCategory>, pageKey: Int): PagedList<Int, Photo> {
        delay(2000)
        ...
        val nextKey = if (end < filtered.size) pageKey + 1 else null
        return PagedList(photos, nextKey)
    }
