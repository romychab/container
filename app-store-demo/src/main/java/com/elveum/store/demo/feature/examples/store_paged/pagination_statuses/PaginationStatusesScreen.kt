...
fun PaginationStatusesScreen() {
    ...
    val result by viewModel.booksFlow.collectAsState()
    ...
    DemoScaffold(
        ...
        scrollable = false,
        description = """
            Combine pull-to-refresh, incremental paging, and error handling with **PagedStore**.
        ...
        PullToRefreshBox(
            ...
            when (val finalResult = result) {
                StoreResult.Loading -> CircularProgressIndicator(modifier = Modifier.align(Alignment.Center))
