...
import com.elveum.store.demo.feature.examples.ExampleScreen
...
import com.elveum.store.demo.feature.home.HomeScreen
    ...
    CompositionLocalProvider(
        ...
        NavDisplay(
            ...
            entryProvider = entryProvider {
                ...
                entry<CatDetailsRoute> { it.Content() }
                entry<CartRoute> { it.Content() }
                entry<ProductDetailsRoute> { it.Content() }
            },
        )
    }
}
