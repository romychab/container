...
internal class LazyCacheImpl<Arg, T>(
    ...
    override fun reset() = monitor.synchronized {
    ...
    private fun registerRecord(arg: Arg): CacheRecord<T> = monitor.synchronized {
    ...
    private fun unregisterRecord(arg: Arg) = monitor.synchronized {
    ...
    private fun getSubject(arg: Arg): LazyFlowSubject<T>? = monitor.synchronized {
