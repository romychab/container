...
internal class FlowDependencyStoreImpl(
    ...
    override fun begin(reloadDependencies: Boolean) = lock.withLock {
        activeKeys.clear()
    ...
    override suspend fun <R> dependsOn(
        ...
        val awaitFunction: suspend () -> R = lock.withLock {
    ...
    override fun end() = lock.withLock {
    ...
    override fun shutdown() = lock.withLock {
