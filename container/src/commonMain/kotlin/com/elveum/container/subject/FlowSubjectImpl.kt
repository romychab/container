...
internal class FlowSubjectImpl<T> : FlowSubject<T> {
    ...
    private fun add(listener: Listener<T>) = monitor.synchronized {
        val state = this.state
    ...
    private fun remove(listener: Listener<T>) = monitor.synchronized {
