...
internal class LazyFlowSubjectImpl<T>(
    ...
    private val monitor = loadTaskManager.monitor
    ...
    override fun updateWith(container: Container<T>) = monitor.synchronized {
    ...
    private fun onStart() = monitor.synchronized {
    ...
    private fun onStop() = monitor.synchronized {
        collectorsCountFlow.value--
