 ...
 */
public fun <State, T1, T2> ReducerOwner.combineContainersToReducer(
 ...
 * into output state by using [initialState] and [nextState] functions.
 */
public fun <State, T1, T2, T3> ReducerOwner.combineContainersToReducer(
    flow1: Flow<Container<T1>>,
    flow2: Flow<Container<T2>>,
 ...
 * into output state by using [initialState] and [nextState] functions.
 */
public fun <State, T1, T2, T3, T4> ReducerOwner.combineContainersToReducer(
    flow1: Flow<Container<T1>>,
    flow2: Flow<Container<T2>>,
    flow3: Flow<Container<T3>>,
 ...
 * into output state by using [initialState] and [nextState] functions.
 */
public fun <State, T1, T2, T3, T4, T5> ReducerOwner.combineContainersToReducer(
    flow1: Flow<Container<T1>>,
    flow2: Flow<Container<T2>>,
    flow3: Flow<Container<T3>>,
    flow4: Flow<Container<T4>>,
